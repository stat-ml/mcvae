...
## ULA_VAE
python main.py --model ULA_VAE --dataset mnist --act_func leakyrelu --binarize True --use_barker False --hidden_dim 64 --batch_size 100 --net_type conv --num_samples 1 --max_epochs 30 --step_size 0.1 --K 3 --track_grad_norm 2 --use_transforms True
