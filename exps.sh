...
python main.py --model AIS_VAE --dataset mnist --act_func gelu --binarize True --use_barker False --hidden_dim 64 --batch_size 100 --net_type conv --num_samples 1 --max_epochs 30 --step_size 0.01 --K 2 --track_grad_norm 2 --use_cloned_decoder False --grad_clip_val 10 --grad_skip_val 50
