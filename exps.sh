...
## ULA_VAE
python main.py --model ULA_VAE --dataset mnist --act_func leakyrelu --binarize True --use_barker False --hidden_dim 64 --batch_size 100 --net_type conv --num_samples 1 --max_epochs 30 --step_size 0.01 --K 5 --use_transforms True --track_grad_norm 2
...
python main.py --model ULA_VAE --dataset celeba --act_func leakyrelu --binarize False --use_barker False --hidden_dim 64 --batch_size 50 --net_type conv --num_samples 1 --max_epochs 30 --limit_train_batches 0.1 --limit_val_batches 0.1 --step_size 0.01 --K 5 --use_transforms True --track_grad_norm 2