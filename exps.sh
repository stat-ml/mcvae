...
CUDA_VISIBLE_DEVICES=1 python main.py --model ULA_VAE --dataset mnist --binarize True --batch_size 50 --num_samples 1 --max_epochs 100 --step_size 0.01 --K 5 --variance_sensitive_step True --ula_skip_threshold 0.5 --acceptance_rate_target 0.99 --annealing_scheme sigmoidal --gpus 1
