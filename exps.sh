...
## ULA_VAE
#python main.py --model ULA_VAE --dataset mnist --act_func gelu --binarize True --hidden_dim 64 --batch_size 100 --net_type conv --num_samples 1 --max_epochs 30 --step_size 0.01 --K 5 --use_transforms True --track_grad_norm 2
...
python main.py --model AIS_VAE --dataset mnist --act_func gelu --binarize True --use_barker False --hidden_dim 64 --batch_size 100 --net_type conv --num_samples 1 --max_epochs 30 --step_size 0.02 --K 1 --track_grad_norm 2 --grad_clip_val 50 --grad_skip_val 100
python main.py --model AIS_VAE --dataset mnist --act_func gelu --binarize True --use_barker False --hidden_dim 64 --batch_size 100 --net_type conv --num_samples 1 --max_epochs 30 --step_size 0.02 --K 2 --track_grad_norm 2 --grad_clip_val 50 --grad_skip_val 100
python main.py --model AIS_VAE --dataset mnist --act_func gelu --binarize True --use_barker False --hidden_dim 64 --batch_size 100 --net_type conv --num_samples 1 --max_epochs 30 --step_size 0.02 --K 3 --track_grad_norm 2 --grad_clip_val 50 --grad_skip_val 100
python main.py --model AIS_VAE --dataset mnist --act_func gelu --binarize True --use_barker False --hidden_dim 64 --batch_size 100 --net_type conv --num_samples 1 --max_epochs 30 --step_size 0.02 --K 5 --track_grad_norm 2 --grad_clip_val 50 --grad_skip_val 100
python main.py --model AIS_VAE --dataset mnist --act_func gelu --binarize True --use_barker False --hidden_dim 64 --batch_size 100 --net_type conv --num_samples 1 --max_epochs 30 --step_size 0.02 --K 10 --track_grad_norm 2 --grad_clip_val 50 --grad_skip_val 100
#
