...
CUDA_VISIBLE_DEVICES=1 python main.py --model ULA_VAE --dataset cifar --binarize False --hidden_dim 128 --batch_size 50 --num_samples 1 --max_epochs 100 --step_size 0.01 --K 10 --variance_sensitive_step True --ula_skip_threshold 0.3 --acceptance_rate_target 0.9 --annealing_scheme all_learnable --grad_clip_val 50 --gpus 1